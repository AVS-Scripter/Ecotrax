...
import { Trophy, Users, Star, Target, ArrowUp, Zap, Calendar, Heart } from 'lucide-react';
...
const challenges = [
  ...
  { id: 2, title: 'Clean Central River', category: 'Cleanup', progress: 32, participants: 840, deadline: '12 days left', icon: Target },
  { id: 3, title: 'Zero Waste Week', category: 'Lifestyle', progress: 90, participants: 2500, deadline: '2 days left', icon: Calendar },
];
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="glass p-6 rounded-2xl border border-white/5 min-w-[240px] flex items-center justify-between">
          <div>
            ...
            <div className="text-2xl font-bold font-headline">#452</div>
          </div>
          <div className="h-10 w-[1px] bg-white/10" />
          <div className="text-right">
            <div className="text-xs text-muted-foreground uppercase tracking-widest mb-1">Total Points</div>
            <div className="text-2xl font-bold font-headline text-primary">2,480</div>
          </div>
        </div>
      </header>
      ...
      <div className="grid lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Button variant="link" className="text-primary p-0">Browse All</Button>
          </div>
